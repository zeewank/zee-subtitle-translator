...
wget -qO- https://raw.githubusercontent.com/zeewank/zee-subtitle-translator/main/bootstrap_installer.sh | bash

# Or download manually:
curl -O https://raw.githubusercontent.com/zeewank/zee-subtitle-translator/main/bootstrap_installer.sh
chmod +x bootstrap_installer.sh
./bootstrap_installer.sh
```

**Windows:**
1. Download [bootstrap_installer.bat](https://raw.githubusercontent.com/zeewank/zee-subtitle-translator/main/bootstrap_installer.bat)
